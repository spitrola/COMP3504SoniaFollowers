...
namespace UniBlu.Repository
{
	class AnnouncementRepository
	{
        ...
        private List<AnnouncementGroup> announcementGroups = new List<AnnouncementGroup>();
        private String url = "http://comp3504uniblu.azurewebsites.net/api/announcements/";
        ...
        {
            loadAnnouncementData(url);
        }

        private void loadAnnouncementData(String url)
        {
            WebClient announcementRequest = new WebClient();
            String announcementJson = announcementRequest.DownloadString(url);

            announcementGroups = JsonConvert.DeserializeObject<List<AnnouncementGroup>>(announcementJson);
        }
